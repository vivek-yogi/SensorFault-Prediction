...
from src.sensor.entity.artifact_entity import ModelPusherArtifact,ModelTrainerArtifact,ModelEvaluationArtifact

from src.sensor.entity.config_entity import ModelEvaluationConfig,ModelPusherConfig
